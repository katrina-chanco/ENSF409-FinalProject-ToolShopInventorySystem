...
/**
 * Starting point for the application, controls the GUI elements and connection to the client
 *
 */
public class GUIController {
	 ...
	 * Starts with a login, then if successful starts the client connection, and starts the GUI, then sets the actionListeners for the buttons
	 * @param args
	 */
